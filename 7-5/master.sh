...
echo "[TASK 1] Initial Kubernetes - IPVS mode , Pod CIDR 172.16.0.0/16 , Service CIDR 10.200.1.0/24 , API Server 192.168.10.10"
cat <<EOT > $HOME/install.yaml
...
ipvs:
  strictARP: true
EOT
kubeadm init --config $HOME/install.yaml
