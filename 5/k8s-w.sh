...
echo "[TASK 4] Install calicoctl Tool - v$1"
curl -L https://github.com/projectcalico/calico/releases/download/v$1/calicoctl-linux-arm64 -o calicoctl >/dev/null 2>&1
